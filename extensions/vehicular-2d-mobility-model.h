 ...
 */
#ifndef VEHICULAR_2D_MOBILITY_MODEL_H
#define VEHICULAR_2D_MOBILITY_MODEL_H
 ...
 * model.
 */
class Vehicular2dMobilityModel : public MobilityModel
{
public:
...
private:
  ...
  VehicularVelocityHelper m_helper;

  EventId m_event;
  enum Mode m_mode;
  double m_modeDistance;
  double m_uniqueDirection;
  Time m_modeTime;
...
#endif /* VEHICULAR_2D_MOBILITY_MODEL_H */
